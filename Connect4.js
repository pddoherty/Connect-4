let gameGrid = new Array(6);
    for(let i = 0; i < 6; i++)
    {
        gameGrid[i] = new Array(7);
    }
...
function right(row, col, color, count)
{
    ...
    {
        if(gameGrid[row][parseInt(col)+1]== color && parseInt(col)+1<7)
        {
            count++;
...
function northEast(row, col, color, count)
{
    ...
    else if(gameGrid[row-1][parseInt(col)+1]== color && (row-1>=0 && parseInt(col)+1<=7))
    {
        count++;
...
function southEast(row, col, color, count)
{
    ...
    else
    {
      ...
      else if(gameGrid[parseInt(row)+1][parseInt(col)+1]==color && (parseInt(row)+1<5 && parseInt(col)+1<6))
      {
            count++;
